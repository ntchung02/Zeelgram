const BirthDayOption = ({ handleSelectChange, selectedDate }) => {
  return (
    <div className="px-2">
      <select
        title="Month:"
        className="mx-2 mt-2 h-[36px] w-[97px]  rounded-sm bg-gray-50 pl-2 text-xs text-gray-500 ring-1 ring-gray-200"
      ...
      <select
        className="mx-2 mt-2 h-[36px] w-[50px] rounded-sm  bg-gray-50  text-xs text-gray-500 ring-1 ring-gray-200"
        title="Day:"
      ...
      <select
        className="mx-2 mt-2 h-[36px] w-[64px] rounded-sm  bg-gray-50 text-xs text-gray-500 ring-1 ring-gray-200"
        title="Year:"
